package com.omer.iocanddi.chapter3.autowiring.byname;
...
class FieldTarget{
    ...
    @Autowired @Qualifier("foo3") Foo3 fooOne;
    @Autowired @Qualifier("anotherFoo") AnotherFoo fooTwo;
    @Autowired @Qualifier("bar3") Bar3 bar;
}
