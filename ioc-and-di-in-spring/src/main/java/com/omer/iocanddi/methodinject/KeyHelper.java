 ...
 *
 * @Component("keyHelper"):
 * Bu anotasyon, Spring'e bu sınıfın bir Spring bileşeni olduğunu ve yönetilmesi gerektiğini söylüyor.
 ...
 * @Scope("prototype"):
 * Bu anotasyon, Spring'te bu bileşenin prototype scope ile kullanılacağını belirtir.
