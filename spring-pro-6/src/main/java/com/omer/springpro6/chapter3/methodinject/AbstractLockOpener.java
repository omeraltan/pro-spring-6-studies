 ...
 *
 * @Component("abstractLockOpener"): Bu anotasyon, AbstractLockOpener sınıfını Spring'in yönetimindeki bir bileşen (component) olarak tanımlar.
 * "abstractLockOpener" adıyla bir bean olarak Spring konteynerinde yer alır ve bu isimle erişilebilir.
 * @Lookup("keyHelper"): Bu önemli anotasyon, Spring’in prototype scope'lu bean’leri dinamik olarak almasını sağlar.
